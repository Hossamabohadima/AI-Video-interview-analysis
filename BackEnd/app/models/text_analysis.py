...
def extract_words_and_text(whisper_result):
    """
...
def get_word_repetition(full_text):
    """
...
def grammar_mistakes(full_text):
    """
...
class TextAnalysis(IAnalysisModel):
    ...
    def analyze(self, input_data: AnalysisInput) -> dict:
        ...
        repetition = get_word_repetition(full_text)
        grammar_errors = grammar_mistakes(full_text)
